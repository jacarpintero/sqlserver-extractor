...
description: Python best practices covering type-first development, illegal-state prevention, discriminated unions, structured logging, and error handling patterns.
---

# Python Best Practices

Follows type-first, functional, and error handling patterns. This skill covers language-specific idioms only.
